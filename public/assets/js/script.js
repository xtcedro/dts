...
import { handleAdminLogin } from './login.js'; // ✅ Import login handler
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // ✅ Admin Login (only if login form is present)
    handleAdminLogin("#login-form", "#username", "#password", "#login-message");
});